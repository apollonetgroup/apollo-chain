...
import org.apollo.core.db2.common.HashDB;
import org.apollo.core.db2.common.Key;
import org.apollo.core.db2.common.Value;
import org.apollo.core.db2.common.WrappedByteArray;
import org.apollo.core.db2.common.Value.Operator;
...
public class SnapshotImpl extends AbstractSnapshot<Key, Value> {
  ...
  public Iterator<Map.Entry<byte[], byte[]>> iterator() {
    ...
    Iterator i1 = Iterators.transform(all.entrySet().iterator(),
            e -> Maps.immutableEntry(e.getKey().getBytes(), e.getValue().getBytes()));
    Iterator i2 = Iterators.filter(getRoot().iterator(),
