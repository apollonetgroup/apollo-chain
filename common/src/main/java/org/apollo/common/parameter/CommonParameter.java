package org.apollo.common.parameter;
...
import org.apollo.core.config.args.Overlay;
...
public class CommonParameter {
  ...
  @Parameter(names = {"--contract-parse-enable"},
      description = "enable contract parses in java-apollo or not.(true or false)")
  ...
  //If you are running a solidity node for java apollo, this flag is set to true
  @Getter
  @Setter
