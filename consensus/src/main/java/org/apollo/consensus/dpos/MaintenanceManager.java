...
import static org.apollo.common.utils.WalletUtil.getAddressStringList;
...
import org.apollo.consensus.pbft.PbftManager;
...
public class MaintenanceManager {
  ...
  public void doMaintenance() {
    ...
    AccountCapsule ac = consensusDelegate.getAccountStore().getGrant();
    delegationStore.setWitnessVote(dynamicPropertiesStore.getCurrentCycleNumber(), ac.createDbKey(), totalVote);
