...
import static org.apollo.common.utils.Commons.getAssetIssueStoreFinal;
import static org.apollo.common.utils.Commons.getExchangeStoreFinal;
import static org.apollo.common.utils.WalletUtil.isConstant;
...
import static org.apollo.core.config.Parameter.DatabaseConstants.EXCHANGE_COUNT_LIMIT_MAX;
import static org.apollo.core.config.Parameter.DatabaseConstants.MARKET_COUNT_LIMIT_MAX;
import static org.apollo.core.config.Parameter.DatabaseConstants.PROPOSAL_COUNT_LIMIT_MAX;
...
import org.apollo.api.GrpcAPI.Address;
...
import org.apollo.api.GrpcAPI.DecryptNotes;
import org.apollo.api.GrpcAPI.DecryptNotesTRC20;
import org.apollo.api.GrpcAPI.DelegatedResourceList;
import org.apollo.api.GrpcAPI.DiversifierMessage;
import org.apollo.api.GrpcAPI.ExchangeList;
import org.apollo.api.GrpcAPI.ExpandedSpendingKeyMessage;
import org.apollo.api.GrpcAPI.IncomingViewingKeyMessage;
import org.apollo.api.GrpcAPI.NfParameters;
import org.apollo.api.GrpcAPI.NfTRC20Parameters;
import org.apollo.api.GrpcAPI.Node;
...
import org.apollo.api.GrpcAPI.PaymentAddressMessage;
import org.apollo.api.GrpcAPI.PrivateParameters;
import org.apollo.api.GrpcAPI.PrivateParametersWithoutAsk;
import org.apollo.api.GrpcAPI.PrivateShieldedTRC20Parameters;
import org.apollo.api.GrpcAPI.PrivateShieldedTRC20ParametersWithoutAsk;
import org.apollo.api.GrpcAPI.ProposalList;
import org.apollo.api.GrpcAPI.ReceiveNote;
import org.apollo.api.GrpcAPI.Return;
import org.apollo.api.GrpcAPI.ShieldedAddressInfo;
import org.apollo.api.GrpcAPI.ShieldedTRC20Parameters;
import org.apollo.api.GrpcAPI.ShieldedTRC20TriggerContractParameters;
import org.apollo.api.GrpcAPI.SpendAuthSigParameters;
import org.apollo.api.GrpcAPI.SpendNote;
...
import org.apollo.api.GrpcAPI.DecryptNotes.NoteTx;
import org.apollo.api.GrpcAPI.Return.response_code;
import org.apollo.api.GrpcAPI.TransactionExtention.Builder;
...
import org.apollo.common.zksnark.IncrementalMerkleTreeContainer;
import org.apollo.common.zksnark.IncrementalMerkleVoucherContainer;
import org.apollo.common.zksnark.JLibrustzcash;
import org.apollo.common.zksnark.LibrustzcashParam.ComputeNfParams;
import org.apollo.common.zksnark.LibrustzcashParam.CrhIvkParams;
import org.apollo.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.apollo.common.zksnark.LibrustzcashParam.SpendSigParams;
...
import org.apollo.core.actuator.ActuatorFactory;
import org.apollo.core.actuator.VMActuator;
...
import org.apollo.core.capsule.BlockBalanceTraceCapsule;
...
import org.apollo.core.capsule.IncrementalMerkleVoucherCapsule;
...
import org.apollo.core.capsule.PedersenHashCapsule;
...
import org.apollo.core.exception.NonUniqueObjectException;
import org.apollo.core.exception.PermissionException;
import org.apollo.core.exception.SignatureFormatException;
...
import org.apollo.core.zen.ShieldedTRC20ParametersBuilder;
import org.apollo.core.zen.ZenTransactionBuilder;
import org.apollo.core.zen.ShieldedTRC20ParametersBuilder.ShieldedTRC20ParametersType;
import org.apollo.core.zen.address.DiversifierT;
import org.apollo.core.zen.address.ExpandedSpendingKey;
import org.apollo.core.zen.address.IncomingViewingKey;
import org.apollo.core.zen.address.KeyIo;
import org.apollo.core.zen.address.PaymentAddress;
import org.apollo.core.zen.address.SpendingKey;
import org.apollo.core.zen.note.Note;
import org.apollo.core.zen.note.NoteEncryption;
import org.apollo.core.zen.note.OutgoingPlaintext;
import org.apollo.core.zen.note.NoteEncryption.Encryption;
import org.apollo.protos.Protocol;
import org.apollo.protos.Protocol.Account;
import org.apollo.protos.Protocol.Block;
import org.apollo.protos.Protocol.DelegatedResourceAccountIndex;
...
import org.apollo.protos.Protocol.MarketPrice;
...
import org.apollo.protos.contract.ShieldContract.IncrementalMerkleTree;
import org.apollo.protos.contract.ShieldContract.IncrementalMerkleVoucherInfo;
import org.apollo.protos.contract.ShieldContract.OutputPoint;
import org.apollo.protos.contract.ShieldContract.OutputPointInfo;
import org.apollo.protos.contract.ShieldContract.PedersenHash;
import org.apollo.protos.contract.ShieldContract.ReceiveDescription;
import org.apollo.protos.contract.ShieldContract.ShieldedTransferContract;
...
import org.apollo.protos.contract.SmartContractOuterClass.SmartContractDataWrapper;
...
public class Wallet {
  ...
  public GrpcAPI.Return broadcastTransaction(Transaction signedTransaction) {
    ...
    try {
      ...
      if (minEffectiveConnection != 0) {
        if (apolloNetDelegate.getActivePeer().isEmpty()) {
          logger
        ...
        int count = (int) apolloNetDelegate.getActivePeer().stream()
      ...
      apolloNetService.broadcast(message);
  ...
  public AccountResourceMessage getAccountResource(ByteString accountAddress) {
    ...
    builder.setFreeNetUsed(accountCapsule.getFreeNetUsage())
        ...
        .setTotalNetLimit(totalNetLimit)
        .setTotalNetWeight(totalNetWeight)
        .setTotalApolloPowerWeight(totalTronPowerWeight)
        .setEnergyLimit(energyLimit)
        .setEnergyUsed(accountCapsule.getAccountResource().getEnergyUsage())
        .setApolloPowerUsed(allTronPowerUsage)
        .setApolloPowerLimit(allTronPower)
  ...
  public DiversifierMessage getDiversifier() throws ZksnarkException {
    ...
    byte[] d;
    while (true) {
      d = org.apollo.keystore.Wallet.generateRandomBytes(Constant.ZC_DIVERSIFIER_SIZE);
  ...
  public NodeList listNodes() {
    ...
    nodeHandlerMap.entrySet().stream()
        .forEach(v -> {
          org.apollo.common.overlay.discover.node.Node node = v.getValue()
              .getNode();
