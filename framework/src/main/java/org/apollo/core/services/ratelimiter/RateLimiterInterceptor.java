package org.apollo.core.services.ratelimiter;
...
import org.apollo.common.parameter.RateLimiterInitialization.RpcRateLimiterItem;
import org.apollo.core.config.args.Args;
import org.apollo.core.metrics.MetricsKey;
import org.apollo.core.metrics.MetricsUtil;
import org.apollo.core.services.ratelimiter.adapter.DefaultBaseQqsAdapter;
import org.apollo.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter;
import org.apollo.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter;
import org.apollo.core.services.ratelimiter.adapter.IPreemptibleRateLimiter;
import org.apollo.core.services.ratelimiter.adapter.IRateLimiter;
import org.apollo.core.services.ratelimiter.adapter.QpsRateLimiterAdapter;
      ...
      try {
        ...
        switch (cName) {
          case "GlobalPreemptibleAdapter":
            cls = org.apollo.core.services.ratelimiter.adapter.GlobalPreemptibleAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
          case "QpsRateLimiterAdapter":
            cls = org.apollo.core.services.ratelimiter.adapter.QpsRateLimiterAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
          case "IPQPSRateLimiterAdapter":
            cls = org.apollo.core.services.ratelimiter.adapter.IPQPSRateLimiterAdapter.class;
            constructor = cls.getConstructor(String.class);
            obj = constructor.newInstance(params);
            container.add(KEY_PREFIX_RPC, component, (IRateLimiter) obj);
            break;
