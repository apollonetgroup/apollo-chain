...
import org.apollo.api.MonitorGrpc;
...
import org.apollo.api.GrpcAPI.BlockLimit;
import org.apollo.api.GrpcAPI.BlockList;
import org.apollo.api.GrpcAPI.BlockListExtention;
...
import org.apollo.api.GrpcAPI.DecryptNotesMarked;
...
import org.apollo.api.GrpcAPI.EasyTransferMessage;
...
import org.apollo.api.GrpcAPI.IncomingViewingKeyDiversifierMessage;
...
import org.apollo.api.GrpcAPI.TransactionList;
import org.apollo.api.GrpcAPI.TransactionListExtention;
import org.apollo.api.GrpcAPI.TransactionSignWeight;
import org.apollo.api.GrpcAPI.ViewingKeyMessage;
import org.apollo.api.GrpcAPI.WitnessList;
import org.apollo.api.GrpcAPI.Return.response_code;
import org.apollo.api.WalletGrpc.WalletImplBase;
...
import org.apollo.protos.Protocol.NodeInfo;
...
import org.apollo.protos.contract.AssetIssueContractOuterClass.UpdateAssetContract;
import org.apollo.protos.contract.BalanceContract.AccountBalanceRequest;
import org.apollo.protos.contract.BalanceContract.AccountBalanceResponse;
...
import org.apollo.protos.contract.ExchangeContract.ExchangeCreateContract;
import org.apollo.protos.contract.ExchangeContract.ExchangeInjectContract;
import org.apollo.protos.contract.ExchangeContract.ExchangeTransactionContract;
import org.apollo.protos.contract.ExchangeContract.ExchangeWithdrawContract;
import org.apollo.protos.contract.MarketContract.MarketCancelOrderContract;
import org.apollo.protos.contract.MarketContract.MarketSellAssetContract;
import org.apollo.protos.contract.ProposalContract.ProposalApproveContract;
import org.apollo.protos.contract.ProposalContract.ProposalCreateContract;
import org.apollo.protos.contract.ProposalContract.ProposalDeleteContract;
...
public class RpcApiService implements Service {
  ...
  public class DatabaseApi extends DatabaseImplBase {
    ...
    @Override
    public void getBlockReference(org.apollo.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.apollo.api.GrpcAPI.BlockReference> responseObserver) {
  ...
  public class WalletApi extends WalletImplBase {
    ...
    private void checkVoteWitnessAccount(VoteWitnessContract req) {
      ...
      if (dbManager.getDynamicPropertiesStore().supportAllowNewResourceModel()) {
        Preconditions.checkArgument(account.getAllTronPower() < votesCount,
            "apollo power[" + account.getAllTronPower() + "] <  VotesCount[" + votesCount + "]");
      } else {
        Preconditions.checkArgument(account.getTronPower() < votesCount,
            "apollo power[" + account.getTronPower() + "] <  VotesCount[" + votesCount + "]");
      }
    ...
    public void listNodes(EmptyMessage request, StreamObserver<NodeList> responseObserver) {
      ...
      nodeHandlerMap.entrySet().stream()
          .forEach(v -> {
            org.apollo.common.overlay.discover.node.Node node = v.getValue().getNode();
    ...
    public void createShieldedContractParameters(
        ...
        StreamObserver<org.apollo.api.GrpcAPI.ShieldedTRC20Parameters> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void scanShieldedTRC20NotesByIvk(
        ...
        StreamObserver<org.apollo.api.GrpcAPI.DecryptNotesTRC20> responseObserver) {
      long startNum = request.getStartBlockIndex();
      long endNum = request.getEndBlockIndex();
      try {
        checkSupportShieldedTRC20Transaction();
    ...
    public void getTriggerInputForShieldedTRC20Contract(
        ...
        io.grpc.stub.StreamObserver<org.apollo.api.GrpcAPI.BytesMessage> responseObserver) {
      try {
        checkSupportShieldedTRC20Transaction();
