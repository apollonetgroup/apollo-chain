...
import org.apollo.core.services.ratelimiter.RateLimiterContainer;
...
public abstract class RateLimiterServlet extends HttpServlet {
  ...
  private static final String ADAPTER_PREFIX = "org.apollo.core.services.ratelimiter.adapter.";
