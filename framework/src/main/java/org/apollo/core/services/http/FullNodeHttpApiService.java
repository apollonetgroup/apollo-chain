...
import org.apollo.core.services.filter.CorsFilter;
import org.apollo.core.services.filter.HttpInterceptor;
...
public class FullNodeHttpApiService implements Service {
  ...
  public void start() {
    try {
      ...
      FilterHolder cfh = handler.addFilterWithMapping((Class<? extends Filter>) CorsFilter.class, "/*",
              EnumSet.of(DispatcherType.REQUEST));
      context.addFilter(cfh, "/*", EnumSet.of(DispatcherType.REQUEST));
