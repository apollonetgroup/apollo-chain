package org.apollo.common.overlay.server;
...
import org.apollo.common.overlay.message.MessageCodec;
import org.apollo.common.overlay.message.StaticMessages;
import org.apollo.core.db.ByteArrayWrapper;
import org.apollo.core.exception.P2pException;
import org.apollo.core.net.PbftHandler;
import org.apollo.core.net.ApolloNetHandler;
...
public class Channel {
  ...
  public void init(ChannelPipeline pipeline, String remoteId, boolean discoveryMode,
    ...
    apolloNetHandler.setChannel(this);
    pbftHandler.setChannel(this);

    p2pHandler.setMsgQueue(msgQueue);
    apolloNetHandler.setMsgQueue(msgQueue);
  ...
  public void publicHandshakeFinished(ChannelHandlerContext ctx, HelloMessage msg) {
    ...
    ctx.pipeline().addLast("data", apolloNetHandler);
