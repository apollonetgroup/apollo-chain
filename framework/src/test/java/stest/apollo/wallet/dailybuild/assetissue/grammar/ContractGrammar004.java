package stest.apollo.wallet.dailybuild.assetissue.grammar;

import static org.apollo.protos.Protocol.Transaction.Result.contractResult.BAD_JUMP_DESTINATION_VALUE;
import static org.apollo.protos.Protocol.Transaction.Result.contractResult.OUT_OF_MEMORY_VALUE;
import static org.apollo.protos.Protocol.Transaction.Result.contractResult.OUT_OF_TIME_VALUE;
import static org.apollo.protos.Protocol.Transaction.Result.contractResult.REVERT_VALUE;
import static org.apollo.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_LARGE_VALUE;
import static org.apollo.protos.Protocol.Transaction.Result.contractResult.STACK_TOO_SMALL_VALUE;
