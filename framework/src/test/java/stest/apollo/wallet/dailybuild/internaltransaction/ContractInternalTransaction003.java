package stest.apollo.wallet.dailybuild.internaltransaction;
...
import stest.apollo.wallet.common.client.utils.Retry;
...
public class ContractInternalTransaction003 {
  ...
  public void dupInternalTrsansactionHash(
      List<org.apollo.protos.Protocol.InternalTransaction> internalTransactionList) {
