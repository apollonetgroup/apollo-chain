package org.apollo.core.zksnark;
...
import org.apollo.common.zksnark.LibrustzcashParam.BindingSigParams;
import org.apollo.common.zksnark.LibrustzcashParam.CheckOutputParams;
import org.apollo.common.zksnark.LibrustzcashParam.CheckSpendParams;
import org.apollo.common.zksnark.LibrustzcashParam.IvkToPkdParams;
import org.apollo.common.zksnark.LibrustzcashParam.OutputProofParams;
...
import org.apollo.core.actuator.ActuatorCreator;
...
import org.apollo.core.capsule.ReceiveDescriptionCapsule;
import org.apollo.core.capsule.SpendDescriptionCapsule;
...
import org.apollo.core.zen.ZenTransactionBuilder.ReceiveDescriptionInfo;
import org.apollo.core.zen.ZenTransactionBuilder.SpendDescriptionInfo;
import org.apollo.core.zen.address.DiversifierT;
import org.apollo.core.zen.address.ExpandedSpendingKey;
import org.apollo.core.zen.address.FullViewingKey;
...
import org.apollo.core.zen.note.Note.NotePlaintextEncryptionResult;
...
import org.apollo.protos.contract.ShieldContract.SpendDescription;
...
public class ShieldedReceiveTest extends BlockGenerate {
  ...
  private static byte[] randomUint256() {
    return org.apollo.keystore.Wallet.generateRandomBytes(32);
  }

  private static byte[] randomUint640() {
    return org.apollo.keystore.Wallet.generateRandomBytes(80);
  }

  private static byte[] randomUint1536() {
    return org.apollo.keystore.Wallet.generateRandomBytes(192);
  }

  private static byte[] randomUint4640() {
    return org.apollo.keystore.Wallet.generateRandomBytes(580);
  }
 ...
 */
  ...
  public void testMemoTooLong() throws ContractValidateException, TooBigTransactionException,
    ...
    byte[] memo = org.apollo.keystore.Wallet.generateRandomBytes(1024);
    ...
    for (org.apollo.protos.Protocol.Transaction.Contract c : t.getRawData().getContractList()) {
  ...
  public void testMemoNotEnough() throws ContractValidateException, TooBigTransactionException,
    ...
    IncomingViewingKey incomingViewingKey = fullViewingKey.inViewingKey();
    PaymentAddress paymentAddress = incomingViewingKey.address(new DiversifierT()).get();
    byte[] memo = org.apollo.keystore.Wallet.generateRandomBytes(128);
    builder.addOutput(expsk.getOvk(), paymentAddress,
        100 * 1000000L - wallet.getShieldedTransactionFee(), memo);
  ...
  public void pushSameSkAndScanAndSpend() throws Exception {
    ...
    byte[] memo = org.apollo.keystore.Wallet.generateRandomBytes(512);
    ...
    for (int i = 0; i < 1; i++) {
      org.apollo.api.GrpcAPI.Note grpcNote = notes1.getNoteTxs(i).getNote();
    ...
    byte[] memo3 = org.apollo.keystore.Wallet.generateRandomBytes(512);
